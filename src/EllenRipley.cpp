...
struct EllenRipley : rack::engine::Module {
    ...
    void process(const ProcessArgs& args) override {
        ...
        float chaosOutput;
        if (chaosStep) {
            // Use chaos rate to control step update frequency
...
struct EllenRipleyWidget : ModuleWidget {
    EllenRipleyWidget(EllenRipley* module) {
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, delayY + 22), module, EllenRipley::DELAY_TIME_L_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, delayY + 22), module, EllenRipley::DELAY_TIME_R_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, delayY + 22), module, EllenRipley::DELAY_FEEDBACK_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, grainY + 22), module, EllenRipley::GRAIN_SIZE_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, grainY + 22), module, EllenRipley::GRAIN_DENSITY_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, grainY + 22), module, EllenRipley::GRAIN_POSITION_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, reverbY + 22), module, EllenRipley::REVERB_ROOM_SIZE_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, reverbY + 22), module, EllenRipley::REVERB_DAMPING_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, reverbY + 22), module, EllenRipley::REVERB_DECAY_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, chaosY + 22), module, EllenRipley::CHAOS_RATE_PARAM));
        x += 31;
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(x + 12, chaosY + 22), module, EllenRipley::REVERB_WET_DRY_PARAM));
        ...
        addParam(createParamCentered<StandardBlackKnob>(Vec(80, 368), module, EllenRipley::CHAOS_AMOUNT_PARAM));
    }
};
