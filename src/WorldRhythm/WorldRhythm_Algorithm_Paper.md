...
Simha Arom（1991）對中非共和國 Banda Linda 族及阿卡俾格米人（Aka Pygmies）音樂的研究，揭示了非洲多聲部打擊樂的複雜互鎖結構。他提出的「最小週期」概念，成為分析非西方節奏的重要工具。需要注意的是，Arom 的研究主要聚焦於中非（Central Africa）地區，而非時間線型態（timeline patterns）最為突出的西非（West Africa）地區，這兩個區域的節奏傳統雖有共通原則，但在具體實踐上有所差異。
