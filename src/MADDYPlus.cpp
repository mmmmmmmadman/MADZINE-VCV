...
struct MADDYPlus : Module {
    ...
    float ch2CvdBuffer[192000];
    float ch3CvdBuffer[192000];
...
json_t* dataToJson() override {
    ...
    switch (clockSourceValue) {
        ...
        float ch2ShiftRegisterCV = (ch2StepDelayValue == 0) ? params[K1_PARAM + ch2StepToKnobMapping[ch2CurrentStep]].getValue() : ch2CvHistory[ch2ShiftRegisterIndex];
        ...
        float ch3ShiftRegisterCV = (ch3StepDelayValue == 0) ? params[K1_PARAM + ch3StepToKnobMapping[ch3CurrentStep]].getValue() : ch3CvHistory[ch3ShiftRegisterIndex];
